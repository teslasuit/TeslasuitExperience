...
#pragma warning restore 0618
        ...
        protected virtual void Update()
        {
            ...
            //Trigger Touched
            if (OVRInput.GetDown(OVRInput.Touch.PrimaryIndexTrigger,OVRInput.Controller.RTrackedRemote)) {
            ...
            //Trigger Touch End
            if (OVRInput.GetUp(OVRInput.Touch.PrimaryIndexTrigger, OVRInput.Controller.RTrackedRemote)) {
            ...
            //Touchpad Touched
            if (OVRInput.GetDown(OVRInput.Touch.PrimaryTouchpad, OVRInput.Controller.RTrackedRemote)) {
            ...
            }else if (OVRInput.GetUp(OVRInput.Button.PrimaryTouchpad, OVRInput.Controller.RTrackedRemote)) {
            ...
            //Touchpad Untouched
            if (OVRInput.GetUp(OVRInput.Touch.PrimaryTouchpad, OVRInput.Controller.RTrackedRemote)) {
